...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
    ...
    Route::get('getProjectSubCategories/{id}', [ProjectSubCategoryController::class, 'getSubCategories'])->name('get_project_sub_categories');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('forecastChart', [ProjectController::class, 'getForecastChartChartData'])->name('projects.forecastChart');
            Route::get('2ndForecastChart', [ProjectController::class, 'get2ndForecastChartChartData'])->name('projects.2ndForecastChart');
    ...
    Route::get('tasks-pro', [ProjectController::class, 'taskPro'])->name('tasks-pro');
    ...
    Route::get('product-dropdown', [ProductController::class, 'productDropdown'])->name('product_dropdown');
    ...
    Route::get('getProduct/{id}', [ProductController::class, 'getProduct'])->name('get_product');
    Route::get('getProductBySubCategory/{id}', [ProductController::class, 'getProductBySubCategory'])->name('get_product_by_sub_category');
    Route::resource('productCategory', ProductCategoryController::class);
    Route::get('productCategory/create-product-category', [ProductCategoryController::class, 'createProductCategory'])->name('create_product_category');
    Route::get('getProductCategories/{id}', [ProductCategoryController::class, 'getCategories'])->name('get_product_categories');
    Route::get('getProductSubCategories/{id}', [ProductSubCategoryController::class, 'getSubCategories'])->name('get_product_sub_categories');
    Route::get('getSelectedProductSubCategories/{id}', [ProductSubCategoryController::class, 'getSelectedServiceSubCategories'])->name('get_selected_product_sub_categories');
    Route::resource('productSubCategory', ProductSubCategoryController::class);
    Route::get('create/product-sub-category', [ProductSubCategoryController::class, 'createSubCategory'])->name('createProductSubCategory');
    Route::get('product-category-dropdown', [ProductSubCategoryController::class, 'categoryDropdown'])->name('product_category_dropdown');
    Route::get('product-sub-category-dropdown', [ProductSubCategoryController::class, 'subCategoryDropdown'])->name('product_sub_category_dropdown');
    ...
    /* COSTS AND COST CATEGORY*/
    Route::resource('costs', CostController::class);
    Route::resource('costCategory', CostCategoryController::class);
    Route::resource('structureCost', StructureCostController::class);
    Route::get('cost-category-dropdown', [CostController::class, 'categoryDropdown'])->name('cost_category_dropdown');
    Route::get('cost-dropdown', [CostController::class, 'costDropdown'])->name('cost_dropdown');
    Route::get('getCostBySubCategory/{id}', [CostController::class, 'getCostByCategory'])->name('get_cost_by_category');
    Route::get('getCost/{id}', [CostController::class, 'getCost'])->name('get_cost');

    // Tax Settings
    Route::resource('taxes', TaxSettingController::class);
    Route::post('taxes/set-default', [TaxSettingController::class, 'setDefaultAddress'])->name('taxes.set_default');
    ...
    Route::get('task-calendar-modal', [TaskCalendarController::class, 'openTaskCalendarModal'])->name('task-calendar-modal');
    ...
    Route::get('getExpense/{id}', [ExpenseController::class, 'getExpense'])->name('get_expense');
    Route::get('getExpenseByCategories/{id}', [ExpenseController::class, 'getExpenseByCategories'])->name('get_expense_by_categories');
    Route::resource('expenseCategory', ExpenseCategoryController::class);
    Route::get('getExpenseCategories/{id}', [ExpenseCategoryController::class, 'getCategories'])->name('get_expense_categories');
    Route::get('expense-dropdown', [ExpenseController::class, 'expenseDropdown'])->name('expense_dropdown');
    Route::get('expense-category-dropdown', [ExpenseController::class, 'categoryDropdown'])->name('expense_category_dropdown');
