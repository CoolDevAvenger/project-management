...
class InvoiceController extends AccountBaseController
{
    ...
    public function addItem(Request $request)
    {
        ...
        // $this->productCategory = ProductCategory::findOrFail($request->productCategoryId);
        // $this->productSubCategory = ProductSubCategory::findOrFail($request->productSubCategoryId);
