    ...
    <div class="col-sm-12">
        <x-form id="save-expense-data-form">
            ...
            <div class="add-client bg-white rounded">
                <div class="row border-bottom-grey px-2 py-2">
                    {{-- <div class="col-md-3">
                        <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                            @lang('app.expense') @lang('app.details'):</h4>
                    </div> --}}
                    <div class="col-md-3">
                        <p class="mb-0 p-20 f-21 text-capitalize font-weight-bold">@lang('app.expenseName'): <span class="font-weight-normal text-capitalize">{{$expense->item_name}}</span></p>
                    </div>
                    @isset($expense->project_id)
                    <div class="col-md-3">
                        <p class="mb-0 p-20 f-21 font-weight-bold text-capitalize">@lang('app.project'): <span class="font-weight-normal text-capitalize">{{$expense->project->project_name}}</span></p>
                    </div>
                    @endisset
                    <div class="col-md-3">
                        <p class="mb-0 p-20 f-21 font-weight-bold text-capitalize">@lang('app.estimatePrice'): <span class="font-weight-normal text-capitalize">{{$expense->price}}</span></p>
                    </div>
                    <div class="col-md-3">
                        <p class="mb-0 p-20 f-21 font-weight-bold text-capitalize">@lang('app.expenseCategory'): <span class="font-weight-normal text-capitalize">{{$expense->category->category_name}}</span></p>
                    </div>
                </div>

                <div class="row p-20">

                    <div class="col-md-6 col-lg-3 @if (!is_null($expense->estimate) || !is_null($expense->project_id)) d-none @endif">
                    ...
                    @if (in_array('employee', user_roles()) && !in_array('admin', user_roles()))
                        <div class="col-md-6 col-lg-3">
                            <x-forms.number class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.actualPrice')" fieldName="actual_price"
                                fieldId="actual_price" :fieldPlaceholder="__('app.actualPrice')"
                                :fieldValue="$expense->actual_price" />
                        </div>
                    @endif
