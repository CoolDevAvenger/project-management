<div class="row">
    <div class="col-sm-12">
        <x-cards.data :title="__('app.menu.expenses') . ' ' . __('app.details')" class=" mt-4">
            ...
            <x-cards.data-row :label="__('app.estimatePrice')" :value="$expense->total_amount" />
            <x-cards.data-row :label="__('app.actualPrice')" value="€{{number_format($expense->actual_price, 2)}}" />
