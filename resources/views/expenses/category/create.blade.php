...
<div class="modal-body">
    ...
    <x-form id="createProjectCategory">
        <div class="row border-top-grey ">
            ...
            <div class="col-sm-12">
                <x-forms.select fieldId="role" :fieldLabel="__('modules.expenseCategory.assignToRole')" fieldName="role[]">
                    @foreach($roles as $role)
        ...
        $.easyAjax({
            ...
            success: function(response) {
                if (response.status == 'success') {
                    if (response.status == 'success') {
                        if(item_no){
                            $('#expense_category_id' + item_no).html(response.data);
                            $('#expense_category_id' + item_no).trigger('change');
