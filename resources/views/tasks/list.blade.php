                    ...
                    <div class="select-others">
                        <select class="form-control select-picker" name="project_id_filter" id="project_id_filter" data-live-search="true"
                            ...
                            @foreach ($projects as $project)
                                <option data-content="{{ $project->project_name }}" value="{{ $project->id }}" @if (isset($taskProjectId) && $taskProjectId == $project->id) selected @endif>{{ $project->project_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            ...
            <div class="col-md-6 d-flex">
                <h5 class="task-project-name font-weight-bold"></h5>
            </div>
...
@push('scripts')
    ...
    <script>
        $('#allTasks-table').on('preXhr.dt', function(e, settings, data) {
            ...
            var projectName = $('#project_id_filter option:selected').data("content");
            $(".task-project-name").html(projectName);
            if (!projectID) {
                projectID = 0;
            }
