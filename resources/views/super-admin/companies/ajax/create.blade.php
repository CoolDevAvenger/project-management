        ...
        <x-form id="save-company-data-form">
            ...
            <div class="add-company bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('modules.client.companyDetails')TTTT</h4>
                <div class="row p-20">
                    ...
                    <div class="col-md-4">
                        <x-forms.number fieldId="vat_no"
                                      :fieldLabel="__('modules.accountSettings.vatnumber')"
                                      fieldName="vat_no"
                                      fieldRequired="true"
                                      fieldPlaceholder="e.g. 12341234567">
                        </x-forms.number>
                    </div>
                </div>
