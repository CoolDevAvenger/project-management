...
<div class="bg-white rounded b-shadow-4 create-inv">
    ...
    <x-form class="c-inv-form" id="saveInvoiceForm">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        <input type="number" id="year" name="year" value="{{$structureCost->year}}"
        ...
        <div id="sortable">
                ...
                @foreach ($structureCost->items as $key => $costItem)
                            ...
                            <tbody>
                                <tr>
                                            ...
                                            <div class="dropdown bootstrap-select form-control select-picker">
                                                <select class="form-control select-picker cost_category_id" name="cost_category_id[]"
                                                    ...
                                                    @foreach ($costCategory as $category)
                                                        <option data-content="{{ $category->category_name }}" value="{{ $category->id }}" @if($costItem->cost_category_id == $category->id) selected @endif>
                                        ...
                                        <div class="input-group">
                                                ...
                                                <select class="form-control select-picker item_id add-cost" data-live-search="true" data-size="8" id="add-cost" name="item_id[]">
                                                    ...
                                                    @foreach ($costs as $item)
                                                        <option data-content="{{ $item->name }}" value="{{ $item->id }}" @if($costItem->cost_id == $item->id) selected @endif>
                                                            {{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                                <input type="hidden"
                                                class="item_name" value="{{$costItem->cost_name}}"
                                                name="item_name[]">
                                                <input type="hidden"
                                                class="cost_ids" value="{{$costItem->id}}"
                                                name="cost_ids[]">
                                                <input type="hidden"
                                                class="cost_id" value="{{$costItem->cost_id}}"
                                                name="cost_id[]">
                                            </div>
                                            <div class="input-group-append">
                                                <a href="javascript:;"
                                    ...
                                    <td width="20%" align="right" valign="top" class="btrr-bbrr">
                                        <span class="amount-html">{{$costItem->cost_price}}</span>
                                        <input type="hidden" class="amount" value="{{$costItem->cost_price}}" name="amount[]" value="0">
                                    </td>
                            ...
                            <table width="100%">
                                <tbody>
                                    <tr class="f-20 f-w-500">
                                        ...
                                        <td class="bg-amt-grey"><span class="total">{{$structureCost->total_structure_cost}}</span></td>
                                        <input type="hidden" value="{{$structureCost->total_structure_cost}}" class="total-field" name="total" value="0">
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        ...
                        <tr class="text-dark-grey font-weight-bold f-14">
                            ...
                            <td width="30%" class="border-0">
                                <input required type="number" min="0"
                                        class="f-14 w-100 text-right hour-number form-control" name="hour_number" value="{{$structureCost->hour_number}}"
                                        placeholder="0">
                            </td>
                        </tr>
                        <tr class="text-dark-grey font-weight-bold f-14">
                            ...
                            <td width="30%" class="border-0">
                                <input required type="number" min="0"
                                        class="f-14 w-100 text-right estimate-employee-cost form-control" name="estimate_employee_cost" value="{{$structureCost->estimate_employee_cost}}"
                                        placeholder="0">
                            </td>
                        </tr>
                        <tr class="text-dark-grey font-weight-bold f-14">
                            ...
                            <td width="30%" class="border-0">
                                <div class="d-flex">
                                    ...
                                    class="f-14 w-100 text-right estimate-hour-percent form-control" name="estimate_hour_percent" value="{{$structureCost->estimate_hour_percent}}"
                                    placeholder="0">
                    ...
                    <tbody>
                        <tr class="text-dark-grey font-weight-bold f-20">
                            ...
                            <td align="right" width="30%"class="f-20 f-w-500 bg-amt-grey">
                                <span class="total-structure-cost-html">{{$structureCost->total_hourly_structure_cost}}</span>
                                <input type="hidden" class="total-structure-cost" value="{{$structureCost->total_hourly_structure_cost}}" name="total_hourly_structure_cost" value="0">
...
<script>
    $(document).ready(function() {
        ...
        $('.save-form').click(function() {
            ...
            calculateStructureCost();
            $.easyAjax({
                url: "{{ route('structureCost.update', $structureCost->id) }}",
