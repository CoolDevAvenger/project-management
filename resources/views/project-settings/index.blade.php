                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-2">
                        ...
                        <x-forms.button-primary icon="plus" id="addProjectCategory"
                                    class="category-btn d-none mb-2 actionBtn"> @lang('modules.statusFields.addProjectCategory')
                        </x-forms.button-primary>

                        <x-forms.button-primary icon="plus" id="addProjectSubCategory"
                                    class="sub-category-btn d-none mb-2 actionBtn"> @lang('modules.statusFields.addProjectSubCategory')
                        </x-forms.button-primary>
                    </div>
