...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.projects.projectSubCategory')</h5>
...
<div class="modal-body">
    ...
    <x-form id="createProjectCategory">
        <div class="row border-top-grey ">
            ...
            <div class="col-sm-12 col-md-6">
                <x-forms.text fieldId="category_name" :fieldLabel="__('modules.projects.projectSubCategory')"
...
<div class="modal-footer">
    ...
    <x-forms.button-primary id="save-sub-category" icon="check">@lang('app.save')</x-forms.button-primary>
</div>
